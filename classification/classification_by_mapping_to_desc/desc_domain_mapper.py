...
class PretrainFastTextClassifier:
    ...
    def evaluate(self, data, session, eval_nodes):
        ...
        for X_batch_domain, X_batch_desc in self.next_batch(data):
            ...
            total_mapping.append(batch_mapping)
            n_batch += 1
    ...
    def run_graph(self):
        ...
        reconstruction_loss = tf.sqrt(tf.losses.mean_squared_error(logits_pred, x_desc, weights=1.0))
        ...
        with tf.Session() as sess:
            ...
            for epoch in range(1, n_epochs + 1):
                ...
                if loss_test == min(test_loss_history):
                    ...
                    pickle.dump(domain2logits, open('domain2mapping.dict', 'wb'))
                    print("DUMPED")
